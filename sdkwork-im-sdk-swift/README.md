# SDKWork IM Swift Workspace

This directory is the Swift workspace inside `sdkwork-im-sdk`.
...
- canonical generator target for Apple platform consumers
- iOS-specific product code should remain outside the generated directory
